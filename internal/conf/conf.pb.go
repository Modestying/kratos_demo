...
type Server struct {
	...
	Web  *Server_Web  `protobuf:"bytes,2,opt,name=web,proto3" json:"web,omitempty"`
}
...
func (x *Server) GetWeb() *Server_Web {
	if x != nil {
		return x.Web
	}
	return nil
...
func (x *Server_Web) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Web) ProtoMessage() {}

func (x *Server_Web) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Web.ProtoReflect.Descriptor instead.
func (*Server_Web) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Server_Web) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x4b, 0x0a, 0x07,
	...
	0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xe5, 0x01, 0x0a, 0x06, 0x53, 0x65,
	...
	0x63, 0x12, 0x28, 0x0a, 0x03, 0x77, 0x65, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16,
	0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x57, 0x65, 0x62, 0x52, 0x03, 0x77, 0x65, 0x62, 0x1a, 0x69, 0x0a, 0x04, 0x47,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x19, 0x0a, 0x03, 0x57, 0x65, 0x62, 0x12, 0x12, 0x0a,
	0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64,
	0x72, 0x22, 0xac, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61,
	...
	0x2f, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Web)(nil),          // 5: kratos.api.Server.Web
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.web:type_name -> kratos.api.Server.Web
